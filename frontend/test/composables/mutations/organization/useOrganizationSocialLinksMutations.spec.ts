...
import { useOrganizationSocialLinksMutations } from "../../../../app/composables/mutations";
...
vi.mock(
  "../../../../app/services/communities/organization/social-link",
  () => ({
...
describe("useOrganizationSocialLinksMutations", () => {
  ...
  describe("updateLink", () => {
    it("calls updateOrganizationSocialLink with orgId, linkId and data on success", async () => {
      const linkId = "link-1";
      const data = { ...sampleSocialLinkInput };
      const { updateLink } = useOrganizationSocialLinksMutations(orgId);
    ...
    it("does not call updateOrganizationSocialLink when orgId is empty", async () => {
      orgId.value = "";
      const { updateLink } = useOrganizationSocialLinksMutations(orgId);
  ...
  describe("createLinks", () => {
    it("calls createOrganizationSocialLinks with orgId and links on success", async () => {
      const links = [sampleSocialLinkInput];
      const { createLinks } = useOrganizationSocialLinksMutations(orgId);
    ...
    it("does not call createOrganizationSocialLinks when orgId is empty", async () => {
      orgId.value = "";
      const { createLinks } = useOrganizationSocialLinksMutations(orgId);
  ...
  describe("deleteLink", () => {
    it("calls deleteOrganizationSocialLink with linkId on success", async () => {
      const linkId = "link-1";
      const { deleteLink } = useOrganizationSocialLinksMutations(orgId);
  ...
  describe("replaceAllLinks", () => {
    it("calls replaceAllOrganizationSocialLinks with orgId and links on success", async () => {
      const links = [sampleSocialLinkInput];
      const { replaceAllLinks } = useOrganizationSocialLinksMutations(orgId);
    ...
    it("does not call replaceAllOrganizationSocialLinks when orgId is empty", async () => {
      orgId.value = "";
      const { replaceAllLinks } = useOrganizationSocialLinksMutations(orgId);
  ...
  describe("readonly state", () => {
    it("returns readonly loading and error", () => {
      const { loading, error } = useOrganizationSocialLinksMutations(orgId);
