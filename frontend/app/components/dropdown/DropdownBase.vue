...
<template>
  <Menu as="div" class="relative inline-block text-left">
    ...
    <MenuItems
      ...
      :class="{
        'absolute right-0 mt-2 origin-top-right divide-y bg-layer-0 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:border dark:border-primary-text z-50':
          !isSidebarLeftMenu,
