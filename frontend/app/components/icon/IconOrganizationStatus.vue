...
<template>
  <span v-if="status == 2">
    <button
      ...
      class="w-5 cursor-pointer sm:w-6 md:w-7 xl:w-9"
    >
  ...
  <span v-else>
    <div
      ...
      "
      class="w-5 sm:w-6 md:w-7 xl:w-9"
    >
      <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        <path
        ...
        />
        <path
          class="fill-warn-yellow/40 dark:fill-warn-yellow/40"
