...
<template>
  <div
    class="border border-action-red bg-action-red/30 px-5 py-5 text-primary-text card-style-base dark:bg-action-red/20"
  >
      ...
      <form method="post">
        ...
        >
          <div class="flex flex-col gap-2">
            ...
            <input
              id="username"
              class="rounded-md border border-primary-text bg-transparent px-3 py-1 focus:outline-none focus:ring-1 focus:ring-primary-text"
            />
          </div>
          <div class="flex flex-col gap-2">
            <h4
