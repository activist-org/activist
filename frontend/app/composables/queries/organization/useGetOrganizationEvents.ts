...
export function useGetOrganizationEvents(
  ...
  const key = computed(() =>
    orgId.value
      ? getKeyForGetOrganizationEvents(orgId.value, filtersRef.value)
      : null
  );
