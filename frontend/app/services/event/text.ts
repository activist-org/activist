...
/**
 * Updates the text content for a specific event by sending a PUT request to the backend API with the updated text data, including the description, get involved prompt, and associated event ID. The function uses the put helper for making HTTP requests and the errorHandler for consistent error handling across the application.
 * @param eventId The unique identifier of the event for which the text content is being updated.
