<template>
  ...
  <div
    ...
    class="elem-shadow-sm bg-layer-1 border-section-div fixed right-0 top-0 z-30 h-screen overflow-y-auto overflow-x-hidden pt-12 transition-[max-width] duration-200"
    :class="{
