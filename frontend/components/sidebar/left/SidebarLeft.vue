<template>
  <aside
    ...
    @mouseleave="
      ...
      setContentScrollable();
    "
    class="absolute z-10 flex-col hidden h-full border-r transition-all motion-reduce:transition-none duration-500 bg-light-layer-1 dark:bg-dark-layer-1 md:flex border-light-section-div dark:border-dark-section-div elem-shadow-sm"
    :class="{
