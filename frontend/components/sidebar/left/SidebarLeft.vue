<template>
  ...
  >
    ...
    <div class="h-full overflow-x-hidden overflow-y-scroll">
      ...
      <SidebarLeftIndex
        v-if="sidebarType === SidebarType.ORGANIZATION_PAGE || sidebarType === SidebarType.EVENT_PAGE"
        class="my-3"
      ...
      <SidebarLeftFilters
        ...
        :class="{
          ...
          'mx-2 py-3':
            sidebar.collapsed && sidebar.collapsedSwitch == true,
        }"
...
<script setup lang="ts">
  ...
  const pathToSidebarTypeMap = [
    ...
    { path: "/organizations", type: isCurrentRoutePathSubpageOf("/organizations/") ? SidebarType.ORGANIZATION_PAGE : SidebarType.FILTER_ORGANIZATIONS },
    { path: "/events", type: isCurrentRoutePathSubpageOf("/events/") ? SidebarType.EVENT_PAGE : SidebarType.FILTER_EVENTS }
  ];
