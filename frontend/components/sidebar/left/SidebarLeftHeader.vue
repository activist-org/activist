  ...
  >
    <div class="flex items-center pt-3 pb-2 pl-[0.625rem] pr-6">
      <div
        ...
        :class="{
          'w-32': sidebar.collapsed == false || sidebar.collapsedSwitch == false,
      ...
      >
        <IconActivist
          ...
          :class="{
            'hidden': sidebar.collapsed == false || sidebar.collapsedSwitch == false,
          }"
      ...
      >
        <button
          ...
          :aria-label="$t('components.sidebar-left-header.sidebar-collapse-aria-label')"
        >
          <div
            class="pb-[2px]"
            :class="{
