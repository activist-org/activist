<template>
    <NuxtLink :to="localePath(`${to}`)" :class="[
            'relative flex items-center justify-center w-full p-2 text-sm text-left transition duration-200 rounded-md basis-full font-md group focus-brand',
            {
