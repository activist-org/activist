<template>
  <div
    class="flex-1 w-full pt-10 pb-8 bg-light-distinct dark:bg-dark-distinct text-light-text dark:text-dark-text sm:pt-12 sm:pb-10 md:pt-16 md:pb-12 lg:pb-14 lg:pt-20 xl:pt-24 xl:pb-16 2xl:pt-28 2xl:pb-18 space-y-4 sm:space-y-9 xl:space-y-10"
  >
