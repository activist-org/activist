<template>
  <div
    class="flex flex-col w-full py-4 xl:py-6 space-y-1 sm:space-y-2 xl:space-y-4 bg-light-highlight dark:bg-dark-highlight text-light-special-text dark:text-dark-special-text"
  >
