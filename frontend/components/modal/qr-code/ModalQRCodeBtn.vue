...
<template>
  <button
    ...
    :aria-label="$t(i18nMap.components.modal_qr_code_btn.open_modal_aria_label)"
  >
    <div class="sm:hidden">
      <Icon
        :name="IconMap.QR_CODE"
        size="2em"
        :alt="$t(i18nMap.components.modal_qr_code_btn.img_alt_text)"
      />
    </div>
  ...
  <MetaTagSocialMedia
    ...
    :text="$t(i18nMap.components.modal_qr_code_btn.qr_code)"
    iconSize="1.5em"
    tabindex="0"
  />
  <ModalQRCode
