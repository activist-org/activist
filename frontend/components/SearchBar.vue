<template>
  <div
    class="flex items-center px-3 py-1 pr-1 mx-3 text-left border select-none space-x-2 transition duration-200 rounded-md bg-light-header dark:bg-dark-header border-light-special-text dark:border-dark-special-text text-light-special-text dark:text-dark-special-text"
  >
