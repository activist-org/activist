<template>
  <RadioGroup
    v-model="value"
    class="divide-primary-text flex h-11 w-full items-center divide-x-2"
  ...
  >
    ...
    >
      <button
        class="border-primary-text h-full flex-1 border-y-2 first:rounded-l-xl first:border-l-2 last:rounded-r-xl last:!border-r-2"
