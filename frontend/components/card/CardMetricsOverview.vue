  ...
  <div class="card-style flex flex-col space-y-3 px-5 py-4">
    <div class="flex w-full items-center">
      <h3 class="responsive-h3 grow text-left font-display">
        {{ $t(i18nMap.components.card_metrics_overview.header) }}
      </h3>
      <DropdownDateFilter />
    </div>
    <div class="grid h-full grid-cols-2 gap-3 lg:grid-cols-4 lg:gap-4">
      <CardMetric
        :text="$t(i18nMap._global.events)"
      ...
      />
      <CardMetric
        :text="$t(i18nMap.components.card_metrics_overview.action)"
      ...
      />
      <CardMetric
        :text="$t(i18nMap.components.card_metrics_overview.learn)"
      ...
      />
      <CardMetric
        :text="$t(i18nMap.components.card_metrics_overview.new_organizations)"
