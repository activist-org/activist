<template>
  <div
    :class="[
      'text-xl font-bold relative min-w-[3.4rem] min-h-[2.75rem]  h-11 first:rounded-l-md last:rounded-r-md border border-light-interactive dark:border-dark-interactive bg-light-header text-light-special-text dark:text-dark-special-text dark:bg-dark-header',
      {
