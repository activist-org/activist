      ...
      <div class="flex items-center justify-between responsive-px-5">
        ...
        <div>
          <div class="flex items-center space-x-3 lg:space-x-4 xl:space-x-6">
            <SelectorTheme />
            <SelectorLanguage />
            <BtnLabeled :cta="true" label="components.website-header.get-in-touch" linkTo="/help/contact" fontSize="sm" class="hidden lg:block" />
            <BtnLabeled :cta="true" label="components.website-header.get-in-touch" linkTo="/help/contact" fontSize="xs"
