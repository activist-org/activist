...
export const newCreateOrganizationModal = (page: Page) => {
  const root = page.getByTestId("modal-ModalCreateOrganization");
...
export type CreateOrganizationModal = ReturnType<
  typeof newCreateOrganizationModal
>;
