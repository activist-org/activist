...
export const newOrganizationPage = (page: Page) => {
  ...
  return {
    ...
    organizationIconUpload: page.locator(
      '[data-upload-type="organization-icon"]'
    ),
    organizationCarouselUpload: page.locator(
      '[data-upload-type="organization-carousel"]'
    ),
    ...
    navigateToSection: async (
      section: "about" | "events" | "groups" | "resources"
    ) => {
      const tabMap = {
