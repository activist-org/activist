...
test.describe(
  ...
  () => {
    ...
    test(
      "About card edit icon is not visible",
      async ({ page }, testInfo) => {
    ...
    test(
      "Get involved card edit icon is not visible",
      async ({ page }, testInfo) => {
        logTestPath(testInfo);
        const { aboutPage } = newEventPage(page);
        await withTestStep(
    ...
    test(
      "Connect card edit icon is not visible",
      async ({ page }, testInfo) => {
        logTestPath(testInfo);
        const { aboutPage } = newEventPage(page);
        await withTestStep(
...
test.describe(
  ...
  () => {
    test(
      "About card edit icon is visible",
      async ({ page }, testInfo) => {
        logTestPath(testInfo);
        const { aboutPage } = newEventPage(page);
        await withTestStep(
    ...
    test(
      "Get involved card edit icon is visible",
      async ({ page }, testInfo) => {
        logTestPath(testInfo);
        const { aboutPage } = newEventPage(page);
        await withTestStep(
    ...
    test(
      "Connect card edit icon is visible",
      async ({ page }, testInfo) => {
        logTestPath(testInfo);
        const { aboutPage } = newEventPage(page);
        await withTestStep(
