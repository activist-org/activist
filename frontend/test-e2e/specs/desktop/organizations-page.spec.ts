...
test.describe("Organizations Page", { tag: "@desktop" }, () => {
  ...
  test("User can share the organization page", async ({ page }) => {
    ...
    const facebookIcon = modal.locator("BtnShareIcon[iconName='IconMap.FACEBOOK']");
    const telegramIcon = modal.locator("BtnShareIcon[iconName='IconMap.TELEGRAM']");
    const mastodonIcon = modal.locator("BtnShareIcon[iconName='IconMap.MASTODON']");
    const instagramIcon = modal.locator("BtnShareIcon[iconName='IconMap.INSTAGRAM']");
    const messengerIcon = modal.locator("BtnShareIcon[iconName='IconMap.MESSENGER']");
