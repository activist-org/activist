<template>
  ...
  >
    ...
    <div class="flex flex-col space-y-4 responsive-py-4 responsive-px-5">
      ...
      <p>
        {{ $t("pages.supporters.showcase.section-2-paragraph-1-1") }}
        <a
      ...
      <h3 class="font-bold responsive-h4">
        {{ $t("pages.supporters.showcase.section-3-1-subheader") }}
      </h3>
      <p class="space-x-1">
        {{ $t("pages.supporters.showcase.section-3-1-paragraph-1-1") }}
        <a
          class="focus-brand link-text"
