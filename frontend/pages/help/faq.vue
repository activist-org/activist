    ...
    <div class="w-10/12 grid grid-cols-1 md:w-full 2xl:grid-cols-2">
      <div class="items-center text-left space-y-4 md:items-start">
        ...
        <p class="sm:text-lg">
          ...
          we get to a point where public discussions are happening, a user will
          only be able to participate if they're a member of an organization.
        </p>
        ...
        <p class="sm:text-lg">
          ...
          will take longer to make sure that they're created in a way that keeps
          people safe.
        </p>
        <p class="font-semibold responsive-text-1">
