<template>
  <div>
    ...
    <div class="container mx-auto md:w-[1200px]">
      <div class="flex container max-md:flex-col mx-auto justify-center p-4">
        ...
        <div class="md:ml-auto md:w-[500px]">
          <form @submit.prevent="sendEmail" class="flex flex-col space-y-2 m-5 ">
            ...
            <button type="submit" class="ml-auto bg-light-cta-orange dark:bg-dark-cta-orange hover:bg-light-cta-orange-light 
                    active:bg-light-cta-orange dark:hover:bg-dark-cta-orange-light dark:active:bg-dark-cta-orange 
                    px-4 py-2 font-medium text-center border rounded-md select-none xl:rounded-lg text-light-distinct 
                    border-light-distinct dark:text-dark-distinct dark:border-dark-distinct focus-brand">Send</button>
          </form>
        </div>
      </div>
    </div>
