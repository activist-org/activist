  ...
  >
    ...
    >
      ...
      <div class="w-10/12 gap-16 2xl:grid 2xl:grid-cols-2 md:w-full">
        ...
        >
          <h1 class="pb-2 font-bold responsive-h1">{{ $t("pages.docs.get-organized.page-title") }}</h1>
          <div class="flex flex-row py-2 space-x-3">
            ...
            />
            <p>
              {{ $t("pages.docs.get-organized.subtitle-1") }}
              <a
              ...
              {{ $t("pages.docs.get-organized.subtitle-3") }}
            </p>
          </div>
          <p>
            {{ $t("pages.docs.get-organized.paragraph-1-pt1") }} <strong>{{ $t("pages.docs.get-organized.paragraph-1-pt2") }}</strong> {{ $t("pages.docs.get-organized.paragraph-1-pt3") }}
          </p>
          <p>
          ...
          <p>
            ...
            <strong>{{ $t("pages.docs.get-organized.paragraph-3-pt2") }}</strong> {{ $t("pages.docs.get-organized.paragraph-3-pt3") }}
          </p>
          <p class="pb-2 md:pb-4">
            {{ $t("pages.docs.get-organized.paragraph-4-pt1") }} <strong>{{ $t("pages.docs.get-organized.paragraph-4-pt2") }}</strong> {{ $t("pages.docs.get-organized.paragraph-4-pt3") }}
            <a
