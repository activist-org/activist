  ...
  <div class="overflow-hidden bg-light-content dark:bg-dark-content">
    ...
    >
      <LandingContent
        ...
        altText="pages.index.get-active-img-alt-text"
      ...
      <LandingContent
        ...
        altText="pages.index.get-organized-img-alt-text"
        btnText1="components.btn-labeled.learn-more"
      ...
      <LandingContent
        ...
        altText="pages.index.grow-organization-img-alt-text"
        btnText1="components.btn-labeled.learn-more"
      ...
      <LandingContent
        ...
        altText="pages.index.activist-section-img-alt-text"
        btnText1="components.btn-labeled.learn-more"
