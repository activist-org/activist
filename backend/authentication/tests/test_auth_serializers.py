...
class TestDeleteUserResponseSerializer:
    def test_auth_serializers_valid_message(self) -> None:
    ...
    def test_auth_serializers_message_max_length_exceeded(self) -> None:
        logger.info(
    ...
    def test_auth_serializers_missing_message_field(self) -> None:
...
class TestSignUpSerializer:
    def test_auth_serializers_valid_data(self) -> None:
    ...
    def test_auth_serializers_password_mismatch(self) -> None:
    ...
    def test_auth_serializers_weak_password(self) -> None:
    ...
    def test_auth_serializers_no_email(self) -> None:
        logger.info("Testing SignUpSerializer with weak password")
        data = {
            "username": "testuser",
            "password": "StrongPass!123",
...
class TestSignInSerializer:
    ...
    def test_auth_serializers_valid_login_with_email(
        self, mock_authenticate, _user
    ) -> None:
        ...
        assert serializer.is_valid()
        assert serializer.validated_data["user"] == _user

    @patch("authentication.serializers.authenticate")
    def test_auth_serializers_valid_login_with_username(
        self, mock_authenticate, _user
    ) -> None:
    ...
    def test_auth_serializers_invalid_credentials(self) -> None:
    ...
    @patch("authentication.serializers.authenticate")
    def test_auth_serializers_unconfirmed_email(self, mock_authenticate, _user) -> None:
        logger.info("Testing SignInSerializer with unconfirmed email")
        mock_authenticate.return_value = _user
        _user.is_confirmed = False
        _user.save()
        data = {"email": "testuser@activist.com", "password": "ValidPass!123"}
        serializer = SignInSerializer(data=data)
...
class TestPasswordResetSerializer:
    ...
    @pytest.fixture
    def _user_with_verification(self):
        logger.info(
    ...
    def test_auth_serializers_validate_with_code(self, _user_with_verification) -> None:
        logger.info("Testing PasswordResetSerializer with valid verification code")
        user, verification_code = _user_with_verification
    ...
    def test_auth_serializers_validate_with_email(
        self, _user_with_verification
    ) -> None:
        logger.info("Testing PasswordResetSerializer with valid email")
        user, _ = _user_with_verification
        serializer = PasswordResetSerializer(
    ...
    def test_auth_serializers_validate_with_invalid_code(
        self, _user_with_verification
    ) -> None:
        logger.info("Testing PasswordResetSerializer with invalid verification code")
        _, _ = _user_with_verification
    ...
    def test_auth_serializers_validate_with_invalid_email(
        self, _user_with_verification
    ) -> None:
        """
