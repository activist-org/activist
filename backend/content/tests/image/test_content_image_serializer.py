...
def test_content_image_serializer_missing_entity_type() -> None:
    """
...
@pytest.mark.django_db
def test_content_image_serializer_missing_entity_id() -> None:
    """
...
@pytest.mark.django_db
def test_content_image_serializer_allows_valid_file() -> None:
    """
