...
def test_content_social_link_create() -> None:
    """
...
@pytest.mark.django_db
def test_content_social_link_organization_serializer() -> None:
    """
...
@pytest.mark.django_db
def test_content_social_link_group_serializer() -> None:
    """
...
@pytest.mark.django_db
def test_content_social_link_event_serializer() -> None:
    """
...
@pytest.mark.django_db
def test_content_social_link_group_list_view(client: APIClient) -> None:
    """
...
@pytest.mark.django_db
def test_content_social_link_event_list_view(client: APIClient) -> None:
    """
...
@pytest.mark.django_db
def test_content_social_link_group_create_view(client: APIClient) -> None:
    """
...
@pytest.mark.django_db
def test_content_social_link_event_create_view(client: APIClient) -> None:
    """
...
def test_content_social_link_str_methods():
    """
