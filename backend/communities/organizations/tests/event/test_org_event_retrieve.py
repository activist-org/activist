...
def _test_org_event_retrieve_list(org_id=None, params=None):
...
def test_org_event_retrieve_org_id_required_bad_request_400():
    response = _test_org_event_retrieve_list(org_id=None)

    assert response.status_code == status.HTTP_400_BAD_REQUEST
    assert response.data == {"detail": "Organization ID is required."}


def test_org_event_retrieve_no_events_returns_empty_payload_ok_200(organization):
    response = _test_org_event_retrieve_list(org_id=organization.id)
...
def test_org_event_retrieve_name_filter_icontains_ok_200(organization):
    keep = _test_org_event_retrieve_make_event(name="Community Cleanup", org=organization)
    ...
    drop = _test_org_event_retrieve_make_event(name="Town Hall", org=organization)
    _test_org_event_retrieve_add_time(
        drop,
...
def test_org_event_retrieve_start_and_end_overlap_filter_ok_200(organization):
    overlapping = _test_org_event_retrieve_make_event(name="Overlapping", org=organization)
    _test_org_event_retrieve_add_time(
        overlapping,
    ...
    outside = _test_org_event_retrieve_make_event(name="Outside", org=organization)
    _test_org_event_retrieve_add_time(
        outside,
...
def test_org_event_retrieve_start_date_only_filter_ok_200(organization):
    keep = _test_org_event_retrieve_make_event(name="Ends On Start", org=organization)
    _test_org_event_retrieve_add_time(
        keep,
    ...
    drop = _test_org_event_retrieve_make_event(name="Ends Before Start", org=organization)
    _test_org_event_retrieve_add_time(
        drop,
...
def test_org_event_retrieve_end_date_only_filter_ok_200(organization):
    keep = _test_org_event_retrieve_make_event(name="Starts On End", org=organization)
    _test_org_event_retrieve_add_time(
        keep,
    ...
    drop = _test_org_event_retrieve_make_event(name="Starts After End", org=organization)
    _test_org_event_retrieve_add_time(
        drop,
